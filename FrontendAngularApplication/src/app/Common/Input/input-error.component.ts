import { Component, computed, DoCheck, effect, Input, input, OnChanges, OnInit, Signal, signal, SimpleChanges } from "@angular/core";
...
@Component({
    ...
    <div *ngIf="inputControl.invalid && inputControl.touched">
        <span class="invalid-feedback" style="display: inline-block;">{{getErrorMessage()}}</span>
    </div>
    `
})
