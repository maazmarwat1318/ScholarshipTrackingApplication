...
namespace WebAPI.MappingProfiles
{
    internal class StudentMappingProfile : Profile
    {
        public StudentMappingProfile()
        {
            ...
            CreateMap<EditStudentViewModel, EditStudentRequest>().ReverseMap();

            CreateMap<StudentResponse, EditStudentViewModel>().ForMember(s => s.StudentId, opt => opt.MapFrom(dest => dest.Id));
